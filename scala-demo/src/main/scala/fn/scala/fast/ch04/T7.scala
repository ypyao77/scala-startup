...
object T7 {
  def pr1() = {
    ...
    val properties: scala.collection.Map[String, String] = propertiesAsScalaMap(System.getProperties).take(10)
  ...
  def pr2() = {
    ...
    // val properties: scala.collection.Map[String, String] = propertiesAsScalaMap(System.getProperties).take(10)
    val properties: scala.collection.Map[String, String] = System.getProperties.asScala.take(10)
    val keyMaxLength = (for (key <- properties.keySet) yield key.length).max
